...
wp_enqueue_style( 'front-page-slider',
  "{$dir}/list-category-posts/style/front-page-slider.css"  );
/*
...
while ( have_posts() ):
  ...
  $lcp_display_output .= '<div class="front-page-slider">';

  $lcp_display_output .= '<div class=\'product-thumbnail\'>';
  //Post Thumbnail
  $lcp_display_output .= $this->get_thumbnail($post);
  $lcp_display_output .= '</div>';
  //Start a List Item for each post:
  $lcp_display_output .= '<div class=\'product-info\'>';

  //Show the title and link to the post:
  $lcp_display_output .= $this->get_post_title($post, 'span', 'product-title');
